...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = /* #__PURE__ */ Object.assign({"./blog/My third post.md": () => import('../chunks/My third post_Cwh1DF7l.mjs').then(n => n._),"./blog/component-classname-pattern.md": () => import('../chunks/component-classname-pattern_Du_ajheu.mjs').then(n => n._),"./blog/first-post.md": () => import('../chunks/first-post_D_O6d4Hc.mjs').then(n => n._),"./blog/second post.md": () => import('../chunks/second post_BJl0xCQs.mjs').then(n => n._)});
