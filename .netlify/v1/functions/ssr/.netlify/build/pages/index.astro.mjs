...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = /* #__PURE__ */ Object.assign({"./blog/My third post.md": () => import('../chunks/My third post_B78DDmSc.mjs').then(n => n._),"./blog/component-classname-pattern.md": () => import('../chunks/component-classname-pattern_Bw9NpMW5.mjs').then(n => n._),"./blog/first-post.md": () => import('../chunks/first-post_-wtj6IYo.mjs').then(n => n._),"./blog/second post.md": () => import('../chunks/second post_hK3zqtRE.mjs').then(n => n._)});
