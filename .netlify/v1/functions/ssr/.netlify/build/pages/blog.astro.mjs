...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./My third post.md": () => import('../chunks/My third post_YwK8Ywd1.mjs').then(n => n._),"./React-vs-Angular-vs-Vue-vs-Svelte.md": () => import('../chunks/React-vs-Angular-vs-Vue-vs-Svelte_C3zQN08m.mjs').then(n => n._),"./component-classname-pattern.md": () => import('../chunks/component-classname-pattern_CDmGL8gY.mjs').then(n => n._),"./first-post.md": () => import('../chunks/first-post_CI5ofSSP.mjs').then(n => n._),"./flutter-forms-validation.md": () => import('../chunks/flutter-forms-validation_BkeEZwU6.mjs').then(n => n._),"./second post.md": () => import('../chunks/second post_DDP1E4NA.mjs').then(n => n._)}), () => "./*.md");
