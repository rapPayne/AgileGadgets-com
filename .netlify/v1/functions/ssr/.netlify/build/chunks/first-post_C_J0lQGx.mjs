...
import 'kleur/colors';
import { $ as $$BlogPost } from './BlogPost_BPvTKiBR.mjs';
...
const html = () => "<p>Welcome to my new blog! This is my first post using Astro’s built-in blog capabilities.</p>\n<h2 id=\"why-astro\">Why Astro?</h2>\n<p>Astro is an amazing static site generator that allows you to:</p>\n<ul>\n<li>Write content in Markdown</li>\n<li>Use your favorite frontend frameworks</li>\n<li>Ship zero JavaScript by default</li>\n<li>Deploy anywhere</li>\n</ul>\n<h2 id=\"whats-next\">What’s Next?</h2>\n<p>Stay tuned for more posts about web development, technology, and more!</p>";
				...
				const frontmatter = {"layout":"../../layouts/BlogPost.astro","title":"My First Blog Post","date":"2024-04-10T00:00:00.000Z","author":"Rap Payne","description":"This is my first blog post using Astro's blog functionality.","tags":["flutter","react","dart","javascript"],"time-to-read":"10 minutes","url":"/blog/first-post","homePageImageUrl":"https://res.cloudinary.com/dn7s3bbox/image/upload/ar_16:9,w_300/q_auto/c_crop/v1731718067/cld-sample-5.webp","listImageUrl":"https://res.cloudinary.com/dn7s3bbox/image/upload/c_fill,ar_1:1,w_200/q_auto/v1731718067/cld-sample-5.webp","mainImageUrl":"https://res.cloudinary.com/dn7s3bbox/image/upload/c_crop,w_1000/q_auto/v1731718067/cld-sample-5.webp"};
				const file = "/Users/rap/Desktop/agile-gadgets/src/pages/blog/first-post.md";
