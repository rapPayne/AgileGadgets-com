...
const $$SiteFooter = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let sortedPosts = [];
  try {
    const posts = /* #__PURE__ */ Object.assign({"../pages/blog/React-vs-Angular-vs-Vue-vs-Svelte.md": () => import('./React-vs-Angular-vs-Vue-vs-Svelte_BlzxkRxi.mjs').then(n => n._),"../pages/blog/a11y-isnt-optional.md": () => import('./a11y-isnt-optional_BDEuiDcR.mjs').then(n => n._),"../pages/blog/component-classname-pattern.md": () => import('./component-classname-pattern_DPIf45xK.mjs').then(n => n._),"../pages/blog/flutter-forms-validation.md": () => import('./flutter-forms-validation_Bd3iKLxW.mjs').then(n => n._),"../pages/blog/hugging-face-api-keys-made-easy.md": () => import('./hugging-face-api-keys-made-easy_Ct9f039a.mjs').then(n => n._),"../pages/blog/hugging-face-spaces.md": () => import('./hugging-face-spaces_BMnD0Ntt.mjs').then(n => n._),"../pages/blog/kaggle-dataset-google-colab.md": () => import('./kaggle-dataset-google-colab_AI96lMF-.mjs').then(n => n._),"../pages/blog/mermaid-diagrams.md": () => import('./mermaid-diagrams_DngY9HLp.mjs').then(n => n._),"../pages/blog/react-hugging-face-inference-api.md": () => import('./react-hugging-face-inference-api_DJsuJQCm.mjs').then(n => n._),"../pages/blog/typescript-types-vs-interfaces.md": () => import('./typescript-types-vs-interfaces_CCfXqUrh.mjs').then(n => n._)});
