import { e as createAstro, f as createComponent, m as maybeRenderHead, h as addAttribute, r as renderTemplate, q as renderSlot, v as renderHead, l as renderComponent } from './astro/server_BAVukojE.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                                     */
...
const $$SiteFooter = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let sortedPosts = [];
  try {
    const posts = /* #__PURE__ */ Object.assign({"../pages/blog/React-vs-Angular-vs-Vue-vs-Svelte.md": () => import('./React-vs-Angular-vs-Vue-vs-Svelte_CrRjmdi4.mjs').then(n => n._),"../pages/blog/a11y-isnt-optional.md": () => import('./a11y-isnt-optional_BsH8vTbT.mjs').then(n => n._),"../pages/blog/component-classname-pattern.md": () => import('./component-classname-pattern_Bm_AW7rI.mjs').then(n => n._),"../pages/blog/flutter-forms-validation.md": () => import('./flutter-forms-validation_BWc2DSsW.mjs').then(n => n._),"../pages/blog/hugging-face-api-keys-made-easy.md": () => import('./hugging-face-api-keys-made-easy_DcVOvhnl.mjs').then(n => n._),"../pages/blog/hugging-face-spaces.md": () => import('./hugging-face-spaces_CSE9FZeo.mjs').then(n => n._),"../pages/blog/jest-using-modules.md": () => import('./jest-using-modules_BndSn2LU.mjs').then(n => n._),"../pages/blog/kaggle-dataset-google-colab.md": () => import('./kaggle-dataset-google-colab_-4QyCKMY.mjs').then(n => n._),"../pages/blog/mermaid-diagrams.md": () => import('./mermaid-diagrams_CYUFy1Ux.mjs').then(n => n._),"../pages/blog/react-hugging-face-inference-api.md": () => import('./react-hugging-face-inference-api_BfmYPgbH.mjs').then(n => n._),"../pages/blog/typescript-types-vs-interfaces.md": () => import('./typescript-types-vs-interfaces_DcrfpMw7.mjs').then(n => n._)});
