...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./My third post.md": () => import('../chunks/My third post_S5hpjBcR.mjs').then(n => n._),"./component-classname-pattern.md": () => import('../chunks/component-classname-pattern_BSINmRBv.mjs').then(n => n._),"./first-post.md": () => import('../chunks/first-post_C_J0lQGx.mjs').then(n => n._),"./second post.md": () => import('../chunks/second post_BLDrLCHj.mjs').then(n => n._)}), () => "./*.md");
