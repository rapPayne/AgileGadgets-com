...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./My third post.md": () => import('../chunks/My third post_Cwh1DF7l.mjs').then(n => n._),"./component-classname-pattern.md": () => import('../chunks/component-classname-pattern_Du_ajheu.mjs').then(n => n._),"./first-post.md": () => import('../chunks/first-post_D_O6d4Hc.mjs').then(n => n._),"./second post.md": () => import('../chunks/second post_BJl0xCQs.mjs').then(n => n._)}), () => "./*.md");
