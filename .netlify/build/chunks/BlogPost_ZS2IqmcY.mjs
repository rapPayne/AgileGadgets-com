...
const $$BlogPost = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": frontmatter.title, "data-astro-cid-bvzihdzo": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="blog-post" data-astro-cid-bvzihdzo> <header data-astro-cid-bvzihdzo> <img${addAttribute(frontmatter.mainImageUrl ?? `${cloudinaryImageBaseUrl}/c_fill,w_1000,ar_16:9/q_auto/${frontmatter.cloudinaryImageFileName}`, "src")} alt="" data-astro-cid-bvzihdzo> <h1 data-astro-cid-bvzihdzo>${frontmatter.title}</h1> <div class="metadata" data-astro-cid-bvzihdzo> <time${addAttribute(frontmatter.pubDate, "datetime")} data-astro-cid-bvzihdzo> ${format(new Date(frontmatter.pubDate), "MMMM d, yyyy")} </time> ${frontmatter.author && renderTemplate`<span class="author" data-astro-cid-bvzihdzo>by ${frontmatter.author}</span>`} </div> </header> <div class="content" data-astro-cid-bvzihdzo> ${renderSlot($$result2, $$slots["default"])} </div> </article> ` })} `;
