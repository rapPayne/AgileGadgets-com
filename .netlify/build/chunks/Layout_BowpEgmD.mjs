import { e as createAstro, f as createComponent, m as maybeRenderHead, h as addAttribute, r as renderTemplate, p as renderSlot, q as renderHead, k as renderComponent } from './astro/server_D72iM745.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                                     */
...
const $$SiteFooter = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let sortedPosts = [];
  try {
    const posts = /* #__PURE__ */ Object.assign({"../pages/blog/React-vs-Angular-vs-Vue-vs-Svelte.md": () => import('./React-vs-Angular-vs-Vue-vs-Svelte_BkVxJA_g.mjs').then(n => n._),"../pages/blog/a11y-isnt-optional.md": () => import('./a11y-isnt-optional_BFYy7Ity.mjs').then(n => n._),"../pages/blog/component-classname-pattern.md": () => import('./component-classname-pattern_Du0MAy8U.mjs').then(n => n._),"../pages/blog/flutter-forms-validation.md": () => import('./flutter-forms-validation_C8vhaFPR.mjs').then(n => n._),"../pages/blog/hugging-face-api-keys-made-easy.md": () => import('./hugging-face-api-keys-made-easy_17UP-5BK.mjs').then(n => n._),"../pages/blog/hugging-face-spaces.md": () => import('./hugging-face-spaces_DGZ_8tTK.mjs').then(n => n._),"../pages/blog/kaggle-dataset-google-colab.md": () => import('./kaggle-dataset-google-colab_CboAkq_R.mjs').then(n => n._),"../pages/blog/mermaid-diagrams.md": () => import('./mermaid-diagrams_DF0HyDMZ.mjs').then(n => n._),"../pages/blog/react-hugging-face-inference-api.md": () => import('./react-hugging-face-inference-api_DGwr40fa.mjs').then(n => n._),"../pages/blog/typescript-types-vs-interfaces.md": () => import('./typescript-types-vs-interfaces_DIESkQUV.mjs').then(n => n._)});
